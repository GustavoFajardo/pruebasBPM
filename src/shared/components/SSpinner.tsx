    ...
    const Animation = () => {
        return (
            <div style={{ position: 'fixed', textAlign: 'center' }}>
                <img className={classes["logo"]} alt="spinner" src={process.env.PUBLIC_URL + "/assets/logo_advantage.png"} />
                <Typography style={{ fontSize: '40px', color: '#fff' }}>{props.message ? props.message : 'Quick-bpm'}</Typography>
