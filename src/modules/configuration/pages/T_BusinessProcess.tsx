...
import { ButtonGroup, MenuItem, Paper, SpeedDial, SpeedDialAction, TableCell, TableContainer, Table, TableHead, TextField, TableRow, TableBody, TablePagination, ThemeProvider, IconButton, Tooltip, SelectChangeEvent, Select, Button } from "@mui/material";
import { FiMoreVertical } from "react-icons/fi";
import { BsArrowUp, BsFillCaretLeftFill, BsFillFileEarmarkPersonFill, BsPencilSquare, BsPlus, BsTrash } from "react-icons/bs";
...
export const T_BusinesProcess: React.FC<IDBusinessProcess> = () => {
  ...
  const getBusinessProcessCatalog = async (idBusinessClass: number | null, idCustomerType: number | null, idCharacterization: number | null) => {
    setShowSpinner(true);
                        ...
                        <Col sm={7} className="mt-3 mb-3">
                          <div className="d-flex">
                            <TextField
                              ...
                              id="state"
                              onChange={(e) => onChangeSelect(e.target.value, 1)}
                            >
                      ...
                      >
                          ...
                          <TableRow>
                            <TableCell>ID
                              <Tooltip className="ml-2" title="Ordenar">
                                <IconButton aria-label="delete" size="small" onClick={() => { ordenar(list, 'IDBusinessProcess') }}>
                                  <BsArrowUp />
                                </IconButton>
                              </Tooltip> </TableCell>
                            <TableCell>Código <Tooltip className="ml-2" title="Ordenar">
                              <IconButton aria-label="delete" size="small" onClick={() => { ordenar(list, 'Code') }}>
                                <BsArrowUp />
                              </IconButton>
                            </Tooltip></TableCell>
                            <TableCell>Nombre
                              <Tooltip className="ml-2" title="Ordenar">
                                <IconButton aria-label="delete" size="small" onClick={() => { ordenar(list, 'Name') }}>
                                  <BsArrowUp />
                                </IconButton>
                              </Tooltip>
                            </TableCell>
                        ...
                        <TableBody>
                          {list
                            ...
                            .map((item: any) => (
                              <TableRow hover role="checkbox" key={item.IDBusinessProcess} tabIndex={-1}>
                                ...
                                <TableCell>
                                  <ThemeProvider theme={inputsTheme}>
                                    <Tooltip title="Ver/Asignar caracterizaciones">
                                      ...
                                      ><BsFillFileEarmarkPersonFill /></IconButton>
                                    </Tooltip>
                                  </ThemeProvider>
                                </TableCell>
                                <TableCell>
