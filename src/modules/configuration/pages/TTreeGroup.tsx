      ...
      <div className="col-12  col-md-4">
        <div className="product-grid-item card">
          ...
          <div className="product-grid-item-content">
            ...
            <div className="product-description mt-1"><i className="pi pi-sitemap product-category-icon"></i><span className="product-category">Canal de distribución: </span> {data.DataBeanProperties.DistributionChannelName ? <p>{data.DataBeanProperties.DistributionChannelName}</p> : <p>  No tiene</p>}</div>
          ...
          <div className="product-grid-item-bottom">
            ...
            <Button icon="pi pi-user-plus" className="p-button-sm p-button-secondary" tooltip="Añadir Usuario a Grupo de Trabajo"
              tooltipOptions={{ position: 'bottom', mouseTrack: true, mouseTrackTop: 15 }} onClick={() => {
                dataTAddUserG(data.DataBeanProperties.IDLn);
              }}>
            </Button>
            <Button icon="pi pi-hashtag" className="p-button-sm p-button-secondary" tooltip="Añadir Rol a Grupo de Trabajo"
              tooltipOptions={{ position: 'bottom', mouseTrack: true, mouseTrackTop: 15 }} onClick={() => {
