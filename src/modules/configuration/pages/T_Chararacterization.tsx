...
import { MenuItem, Paper, SpeedDial, SpeedDialAction, TableCell, TableContainer, Table, TableHead, TextField, TableRow, TableBody, TablePagination, Tooltip, IconButton, Menu, ListItemIcon, ListItemText, ButtonGroup, Button, ThemeProvider } from "@mui/material";
                                    ...
                                    <TableRow sx={{ height: "3rem" }}>
                                        <TableCell>ID
                                            <Tooltip className="ml-2" title="Ordenar">
                                                <IconButton aria-label="delete" size="small" onClick={() => { ordenar(listCharacterization, 'IDCharacterization') }}>
                                                    <BsArrowUp />
                                                </IconButton>
                                            </Tooltip>
                                        </TableCell>
                                        <TableCell>Nombre
                                            <Tooltip className="ml-2" title="Ordenar">
                                                <IconButton aria-label="Ordenar" size="small" onClick={() => { ordenar(listCharacterization, 'Name') }}>
                                                    <BsArrowUp />
                                                </IconButton>
                                            </Tooltip></TableCell>
                                        <TableCell>Descripción </TableCell>
                                        <TableCell>Tipo de Cliente
                                        </TableCell>
                                ...
                                <TableBody>
                                    {listCharacterization
                                        ...
                                        .map((item: CharacterizationK) => (
                                            <TableRow hover role="checkbox" key={item.IDCharacterization} tabIndex={-1}>
                                                ...
                                                <TableCell >
                                                    ...
                                                    {/* <Tooltip title="Opciones">
                                                        <IconButton className="mr-3" onClick={handleClick}>
                                                            <BsGearFill />
                                                        </IconButton>
                                                    </Tooltip>
                                                    <Menu
                                                    ...
                                                    >
                                                        <MenuItem onClick={() => {
                                                            ...
                                                            <ListItemIcon>
                                                                <BsPencilSquare /* fontSize="small"  />
                                                            </ListItemIcon>
                                                            <ListItemText>Editar Elemento</ListItemText>
                                                        </MenuItem>
                                                        <MenuItem onClick={() => {
                                                            setAnchorEl(null);
                                                            setShowDelete(true);
                                                            ...
                                                            <ListItemIcon>
                                                                <BsTrash /* fontSize="small"  />
                                                            </ListItemIcon>
                                                            <ListItemText>Eliminar Elemento</ListItemText>
                                                        </MenuItem>
                                                    </Menu> */}
                                                </TableCell>
                                                {/* <TableCell >
