...
import { SpeedDial, SpeedDialAction, ThemeProvider, Button, TextField, Paper, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, TablePagination, MenuItem } from "@mui/material";
...
export const TAddUserWorkG: React.FC<IAddUserWorkG> = (props: IAddUserWorkG) => {
    ...
    return (
        <Modal size="xl" show={props.dataShow} backdrop="static" centered keyboard={false}>
            <Modal.Header>
                ...
                <Row className="mt-3">
                    <Col sm={12}>
                        {(listUsers.length > 0) ?
                            ...
                            : (idOffice === -1)
                                ? ""
                                : <h1>No hay usuarios en esta sucursal</h1>}
                    </Col>
                </Row>
            </Modal.Body>
