...
export const JsonPrototypeDialog: React.FC<JsonPrototype> = (props: JsonPrototype) => {
    ...
    return (
        <>
            <Modal size={sizeDialog} show={props.showDialog} backdrop="static" centered keyboard={false}>
                <Modal.Header>
                    Prototipo Json
                    <BsXSquare onClick={() => { props.setShowDialog(false); props.setResponseJsonSelected("") }} />
                </Modal.Header>
                <Modal.Body>
                    <Row>
                        <Col sm={6}>
