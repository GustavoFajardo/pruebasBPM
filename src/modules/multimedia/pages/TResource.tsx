...
import { Button, ButtonGroup, MenuItem, SpeedDial, SpeedDialAction, ThemeProvider, Tooltip } from "@mui/material";
...
const TResource: React.FC<ITResource> = () => {
  ...
  const [listCategoryResource, setListCategoryResource] = useState<CategoryResource[]>([]);
          ...
          <div className="px-5 mt-2">
            ...
            <div className="row">
              ...
              {(list.length > 0) ?
                        ...
                        {list
                          ...
                          .map((item: Resource, index: number) => (
                            <TableRow hover role="checkbox" tabIndex={-1}>
                              ...
                              <TableCell> <a href={_fileService.getUrlFile(item.Context, item.MediaContext)} target="_blank">{item.MediaContext}</a></TableCell>
                ...
                : selector !== -1 ? <div className="mt-10 ml-20 d-flex justify-content-center"> <NoInfo /> </div>
                  : ""
              }
              {show && (
                <NEResource
