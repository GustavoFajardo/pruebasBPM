...
export const SValidationBioData: React.FC<ISValidationBioData> = (props: ISValidationBioData) => {
    ...
    const handleScan = async () => {
        ...
        await _globalService.validateFingerPrint((user[0].IDAccount + ""), hand, hand === RIGHT_HAND ? counterFinger : (counterFinger - 5))
            .subscribe((resp) => {
                ...
                <div>
                    <Row className="d-flex justify-content-center align-items-center m-5">
                        ...
                        <Col sm={12} className=" mt-5 d-flex justify-content-center">
                            {!alreadyBioData ?
                                <h1>No se encontraron Datos Biométricos para <b>{name}</b> - <b>{identification}</b></h1>
                                : <h1>Validación de Datos Biométricos registrados para <b>{name}</b> - <b>{identification}</b></h1>
                            }
                        </Col>
                        {alreadyBioData &&
                            <Col className="d-flex justify-content-center">
                                <Card className="card-zoom m-10" onClick={() => setState(2)}>
                                    ...
                                    <div className="d-flex flex-column justify-component-center">
                                        ...
                                        <h2 className="ml-5 mt-3">{calcNumRecords(fingerRightPhotos) + calcNumRecords(fingerLeftPhotos)} Registros encontrados</h2>
                                    </div>
                                </Card>
                            </Col>}
                        {alreadyBioData &&
                            <Col className="mt-3">
                                <Card className="card-zoom m-10" onClick={() => setState(3)}>
                                    <Card.Title className="mt-3 ml-5">
                                    ...
                                    <div className="d-flex flex-column">
                                        ...
                                        <h2 className="ml-5 mt-3">{calcNumRecords(personPhotos)} Registros encontrados</h2>
                                    </div>
                                </Card>
                            </Col>}
                        {!alreadyBioData &&
                            <Col className="mt-3" sm={8}>
                                <Card className="card-zoom m-10 d-flex justify-content-center align-items-center" onClick={() => /* setState(6) */ history.push('/bio-data')}>
                                    <Card.Title className="mt-3 ml-5">
                                        <h1 className="">REGISTRAR DATOS BIOMÉTRICOS</h1>
                                    </Card.Title>
                                    <img className="mw-250 ml-5" src={process.env.PUBLIC_URL + "/assets/fingerprints/fg.svg"} alt="userCam-sgv" />
                                </Card>
                            </Col>
                        }
                    </Row>
                ...
                <div>
                    <Row className="d-flex justify-content-between m-10">
                        ...
                        <Col sm={12} className="mt-4 d-flex justify-content-center">
                            <h1>Validación de Huellas para <b>{name}</b> - <b>{identification}</b></h1>
                        </Col>
                        <Col sm={12} className="mt-4 d-flex justify-content-center">
                        ...
                        <Col className="mt-3">
                            <div className="card-zoom m-10 d-flex justify-content-between"
                                onClick={(e) => { setState(4); setHand(RIGHT_HAND); }}
                            >
                                ...
                                <Row className="d-flex flex-column">
                                    <Col sm={12} className=" mt-3 d-flex flex-column">
                                        ...
                                        <h2 className="ml-5 mt-3">{calcNumRecords(fingerRightPhotos)} Registros encontrados</h2>
                                    </Col>
                                </Row>
                            </div>
                        </Col>
                        <Col className="mt-3">
                            <div className="card-zoom m-10 d-flex justify-content-between "
                                onClick={(e) => { setState(5); setHand(LEFT_HAND); setCounterFinger(5); }}
                            >
                                ...
                                <Row className="d-flex flex-column">
                                    <Col sm={12} className="mt-3 d-flex flex-column">
                                        ...
                                        <h2 className="ml-5 mt-3">{calcNumRecords(fingerLeftPhotos)} Registros encontrados</h2>
                                    </Col>
                                </Row>
                            </div>
                        </Col>
            ...
            case 4: return (
                <>
                    <Row className="d-flex justify-content-center mt-3">
                        ...
                        <Col sm={12} className="mt-4 d-flex justify-content-center">
                            <h1>Validaciòn de Huellas para <b>{name}</b> - <b>{identification}</b></h1>
                        </Col>
                    </Row>
    ...
    return (
        <>
            <div className="nWhite w-80 p-3 m-3">
                ...
                <SSpinner show={showSpinnerValidation} message="VALIDANDO DATOS" />
            </div>
        </>
    )
}
