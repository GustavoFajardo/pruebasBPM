...
export class SuscriptionService {
    ...
    createBusinessProcessAndNextStage(idBusinessProcess: number,
        idOffice: number,
        accountID: number,
        description: string,
        alphaCode: String,
    ...
    getProcedureActionByAccount(idAccount: number,
    ...
    getProcedureImpForAssign(idAccount: number,
        idBusinessProcess: number, idOffice: number) {
        const dataObj = {
            "ServiceName": "BpmService",
            "MethodHash": "java.util.List_getProcedureImpForAssign_Number_Number_Number",
            "ArgumentList": [
    ...
    getWorkGroupMember(idProcedure: number,
        nit: number,
        nombre: string,
        apellido: string) {
    ...
    assignProcedureImpToGroupMember(idProcedureImp: number,
        idAccount: number,
    ...
    responseProcedureAction(idProcedureAction: number, description: string, responseValue?: boolean) {
        const dataObj = {
            "IDClient": "$#HHJGUY9773H5MNKD65389745KJDFGDGG==",
            "ServiceName": "BpmService",
            "WSToken": "$#HHJGUYUHSDFGS546546DFH654SGHUJJFF==",
    ...
    declineResponseProcedureAction(idProcedureAction: number, description: string) {
        const dataObj = {
            "ServiceName": "BpmService",
    ...
    reprocessProcedureAction(idAction: number,
        media: string,
        mediaContext: string,
        observations: string) {
        const dataObj = {
            ...
            "ServiceName": "BpmService",
            "WSToken": "$#HHJGUYUHSDFGS546546DFH654SGHUJJFF==",
            "MethodHash": "boolean_reprocessProcedureAction_Number_String_String_String_Boolean",
            "ArgumentList": [
                idAction,
                media,
                mediaContext,
